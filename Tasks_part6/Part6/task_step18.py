...
# чтобы он вывел данный словарь, расположив его элементы по следующему правилу: первый, последний, второй, предпоследний,
# третий, и так далее.
#
...
for form in (len(data) // 2) * (False, True):
    name, value = data.popitem(last=form)
    new_data[name] = value
