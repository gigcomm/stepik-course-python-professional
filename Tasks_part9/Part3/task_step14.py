...
# Дополните приведенный ниже код, чтобы он вывел сумму квадратов всех двузначных чисел из данного списка, которые делятся на 9 без остатка.
#
...
filter_numbers = list(filter(lambda x: x % 9 == 0 and len(str(x)) == 2, abs_numbers))
square_numbers = list(map(lambda x: x ** 2, filter_numbers))
