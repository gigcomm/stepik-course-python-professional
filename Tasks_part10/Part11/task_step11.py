...
group_iter = groupby(sorted(students, key=lambda student: student.name), lambda student: student.name)
max_result = max(group_iter, key=lambda x: sum(1 for _ in x[1]))
print(max_result[0])
